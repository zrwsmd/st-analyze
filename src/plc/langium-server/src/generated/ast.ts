...
export const StTerminals = {
    Signed_integer_type_name: /SINT|INT|DINT|LINT/i,
    Cache_type_name:
    ...
    Real_type_name: /LREAL|REAL/i,
    Unsigned_integer_type_name: /USINT|UINT|UDINT|ULINT/i,
    Bit_string_type_name: /BYTE|WORD|DWORD|LWORD/i,
    Bool_Result_type_name: /TRUE|FALSE/i,
    Bool_type_name: /BOOL/i,
    String_type_name: /STRING/i,
    Date_And_time_type_name: /DATE_AND_TIME/i,
    Time_Of_Day_type_name: /TIME_OF_DAY/i,
    Time_type_name: /TIME/i,
    Date_type_name: /DATE/i,
...
export function isBoolean_literal(item: unknown): item is Boolean_literal {
    return typeof item === 'string' && /TRUE|FALSE/i.test(item);
}
